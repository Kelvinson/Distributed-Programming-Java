...
public class MatrixMult {
    ...
    public static void parallelMatrixMultiply(Matrix a, Matrix b, Matrix c,
        ...
        // Integer rank of the current process in the specified communicator
        final int myrank = mpi.MPI_Comm_rank(mpi.MPI_COMM_WORLD);
        // Number of MPI ranks in the provided communicator
        ...
        // For simplicity, broadcast all of the matrices a & b to all ranks
